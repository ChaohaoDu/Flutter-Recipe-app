...
class _MyAppState extends State<MyApp> {
  Map<String, bool> _filters = {'gluten': false, 'lactose': false, 'vegan': false, 'vegetarian': false};
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: ThemeData.light().textTheme.copyWith(
              ...
              titleMedium: TextStyle(fontSize: 24, fontFamily: 'RobotoCondensed', fontWeight: FontWeight.bold),
            ),
      ),
      // initialRoute: '/',
      routes: {
